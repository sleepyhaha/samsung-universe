...
function runFetch() {
    ...
    console.log(type)
    fetch("https://maps.googleapis.com/maps/api/geocode/json?address=" + userLocation + "&key=AIzaSyDs00mT6NOOoam0gYfRl40xvUX51vedBqk")
        ...
        .then(function (data) {
            ...
            for (const issue of data.results) {
                ...
                //Google Places Fetch
                console.log(type)
                var apiUrl = 'https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=' + latitude + "%2C" + longitude + "&type=" + type + '&radius=6000&key=AIzaSyDs00mT6NOOoam0gYfRl40xvUX51vedBqk';
                console.log(apiUrl)
                fetch(apiUrl, {
                    method: 'GET',
                    headers: [],
                    ...
                    .then(function (data) {
                        ...
                        for (const issue of data.results) {
                            ...
                            let photo = "https://maps.googleapis.com/maps/api/place/photo?maxwidth=300&maxheight=400&photo_reference=" + photoRef + "&sensor=false&key=AIzaSyDs00mT6NOOoam0gYfRl40xvUX51vedBqk"
